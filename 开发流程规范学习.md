...
5. 在本地项目新建并切换到dev分支 与远程分支对应
`git checkout -b dev origin/dev`


6. 项目文件操作,新增READEME.txt文件
![微信截图_20180514181723](https://i.loli.net/2018/05/14/5af9623d62326.png)
...
![QQ截图20180514182002](https://i.loli.net/2018/05/14/5af962c5582b6.png)